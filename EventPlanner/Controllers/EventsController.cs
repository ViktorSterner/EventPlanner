...
namespace EventPlanner.Controllers
{
    public class EventsController : Controller
    {
        ...
        {
            var eventPlannerContext = _context.Event.Include(e => e.Location);
        ...
        public async Task<IActionResult> Create([Bind("ID,LocationID,Name,Time")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LocationID,Name,Time")] Event @event)
        {
            if (id != @event.ID)
            {
                return NotFound();
